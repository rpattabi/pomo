...
import logging
logger = logging.getLogger('pomo_lib')

from . helpers import get_builder, show_uri, get_help_uri

# This class is meant to be subclassed by PomoWindow.  It provides
...
class Window(Gtk.Window):
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated BasePomoWindow object.
        """
        builder = get_builder('PomoWindow')
        new_object = builder.get_object("pomo_window")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a PomoWindow object with it in order to finish
        initializing the start of the new PomoWindow instance.
        """
        ...
        self.settings = Gio.Settings("net.launchpad.pomo")
        ...
        try:
            ...
            LaunchpadIntegration.set_sourcepackagename('pomo')
        except ImportError:
            pass
    ...
    def on_mnu_about_activate(self, widget, data=None):
        """Display the about box for pomo."""
    ...
    def on_mnu_preferences_activate(self, widget, data=None):
        """Display the preferences window for pomo."""
    ...
    def on_mnu_close_activate(self, widget, data=None):
        """Signal handler for closing the PomoWindow."""
        self.destroy()

    def on_destroy(self, widget, data=None):
        """Called when the PomoWindow is closed."""
